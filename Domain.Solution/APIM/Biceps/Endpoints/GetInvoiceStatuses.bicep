...
//Edit the xml file
var raw = loadTextContent('./XML/GetInvoiceStatuses.xml')
var policy = replace(raw, '{1}', environment)

resource endpoint 'Microsoft.ApiManagement/service/apis/operations@2021-12-01-preview' = {
  name: '${service}/${apiName}/GetInvoiceStatuses'
  properties:{
    description: 'Retrieve list of all possible Invoice Statuses'
    displayName: 'GetInvoiceStatuses'
    method: 'GET'
