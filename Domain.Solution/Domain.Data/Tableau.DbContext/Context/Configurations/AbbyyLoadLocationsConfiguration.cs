...
{
    public partial class AbbyyLoadLocationsConfiguration : IEntityTypeConfiguration<AbbyyLoadLocations>
    {
        public void Configure(EntityTypeBuilder<AbbyyLoadLocations> entity)
        {
            entity.HasKey(e => e.PKey).HasName("PK_LaneMatching.AbbyyLoadLocations");

            entity.ToTable("AbbyyLoadLocations", "LaneMatching");
        ...
        partial void OnConfigurePartial(EntityTypeBuilder<AbbyyLoadLocations> entity);
    }
}
